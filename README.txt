...
and the methodolgogy for producing them see McGarragh and Others, 2016.
...
http://eodg.atm.ox.ac.uk/MIE/eodg_mie.tar.gz
...
to this directory and the various dependencies (eodg_mie/, eodg_mie/dlm-code/,
disort/src and dubovik/).  These may be set either as an environmental variable
or within IDL with the PREF_SET command.
...
If you would like to report a bug please a include sample case that reproduces
the bug along with the all the required inputs.


Gareth Thomas, 21/06/2013
Greg McGarragh, 06/09/2016
...
Gregory R. McGarragh and Others. The Community Cloud Retrieval for Climate
(CC4CL). Part II: Theory and algorithm. 2016. To be submitted to Atmospheric
